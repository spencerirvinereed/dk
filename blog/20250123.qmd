...
#| warning: false
#| label: fig-chart
#| fig-cap: "Washington Football Team Winning Percentage: Last 50 Years"
library(tidyverse)
setwd("~/Library/CloudStorage/OneDrive-moxtek.com/R/20250124 DK Website")
df <- read_delim("redskins.txt", delim = "\t", escape_double = FALSE, trim_ws = TRUE)
df$percent=df$Wins/(df$Wins+df$Losses+df$Ties)
df |> 
...
Football with other sports have become a source of entertainment.
